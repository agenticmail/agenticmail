    ...
    res.json({
      ...
      channels: [
        ...
        },
        {
          ...
          setup: 'Run `agenticmail setup`, choose to set up phone calling, pick 46elks or Twilio, enter that provider\'s credentials + webhook base URL, then call phone_readiness. When ready=true, start the first test call with call_phone_safe.',
