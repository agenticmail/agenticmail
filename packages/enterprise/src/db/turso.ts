/**
 * Turso (LibSQL) Database Adapter (stub)
...
export class TursoAdapter extends DatabaseAdapter {
  ...
  async connect(config: DatabaseConfig): Promise<void> {
    try { await import('@libsql/client' as any); } catch { throw new Error('Turso driver not found. Install: npm install @libsql/client'); }
    throw new Error('Turso adapter: full implementation coming in v0.2.0');
  }
